    ...
    <section className="hero-grid relative rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 px-5 py-6 sm:px-10 sm:py-16 overflow-hidden">
      ...
      <div className="relative flex flex-col gap-4 sm:gap-6 max-w-2xl">
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center px-2.5 py-1 rounded-md bg-indigo-50 dark:bg-indigo-950/50 text-xs font-semibold text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/50">
            {count} {t("activeTasks")}
          </span>
        </div>
