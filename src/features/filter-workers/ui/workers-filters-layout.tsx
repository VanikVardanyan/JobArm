...
import { WorkerFilters, type WorkerFiltersCopy } from "@/features/filter-workers/ui/worker-filters";
import { ui } from "@/components/ui/styles";

type FilterItem = { key: string; label: string };

type WorkersFiltersLayoutProps = {
...
export function WorkersFiltersLayout({
  children,
  categories,
  regions,
  openFilters,
        ...
        <Drawer.Portal>
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
              <WorkerFilters {...filterProps} onApplied={() => setDrawerOpen(false)} />
            </div>
          </Drawer.Content>
        </Drawer.Portal>
      </Drawer.Root>
